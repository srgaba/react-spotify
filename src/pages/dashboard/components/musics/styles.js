...
export const FInputTime = styled.div`
    width: ${px2vw(175)};
...
export const FInputArtist = styled.div`
    width: 100%;
    margin-top: ${px2vw(25)};
...
export const MusicSearch = styled.div`
    img{
        position: absolute;
        object: fill;
        width: ${px2vw(40)};
...
export const MusicScroll = styled(PerfectScrollbar)`
...
export const MButtonsEdit = styled.button`
    width: ${px2vw(40)};
    height: ${px2vw(40)};
    background: none;
    border: none;
...
export const MButtonsDel = styled.button`
    width: ${px2vw(40)};
    height: ${px2vw(40)};
...
export const PButtonAdd = styled.button`
    width: ${px2vw(40)};
    height: ${px2vw(40)};
    background: none;
    border: none;
